...
| --- | --- |
| ![Retro Rover boards overview](docs/screenshots/boards-overview.png) | ![Retro Rover create board form](docs/screenshots/create-board-form.png) |
| Board actions menu | Live board view |
| ![Retro Rover boards actions menu](docs/screenshots/boards-actions-menu.png) | ![Retro Rover live board view](docs/screenshots/live-board-view.png) |
